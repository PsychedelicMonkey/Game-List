            ...
            <div class="p-6 bg-white dark:bg-gray-800 shadow rounded-lg">
                <div class="max-w-xl">
                    ...
                    <x-form.main :action="route('game-list.update', $game)">
                        ...
                        <x-input.main type="date" id="release_date" label="{{ __('Release Date') }}" :value="date('Y-m-d', strtotime($game->release_date))" />
                        ...
                        <x-input.main id="steam_url" label="{{ __('Steam URL') }}" :value="$game->urls['steam'] ?? null" />

                        <x-input.main id="tags" label="{{ __('Tags') }}" :value="$game->tags->pluck('name')->implode(', ')" />
