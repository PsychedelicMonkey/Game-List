...
@section('content')
    ...
    <form action="{{ route('game-list.update', $game) }}" method="post">
        ...
        <div>
            ...
            <input type="text" name="developer" id="developer" value="{{ $game->developer->name }}" class="bg-transparent" />
        ...
        <div>
            ...
            <input type="date" name="release_date" id="release_date" value="{{ date('Y-m-d', strtotime($game->release_date)) }}" class="bg-transparent" />
        ...
        <div>
            ...
            <input type="text" name="gog_url" id="gog_url" value="{{ $game->urls['gog'] ?? null }}" class="bg-transparent" />
        ...
        <div>
            ...
            <input type="text" name="steam_url" id="steam_url" value="{{ $game->urls['steam'] ?? null }}" class="bg-transparent" />
